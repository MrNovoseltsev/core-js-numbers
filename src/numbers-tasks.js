...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  // return ((x1 * x2 + y1 * y2) / (Math.sqrt(x1 ** 2 + y1 ** 2) * Math.sqrt(x2 ** 2 + y2 ** 2))) * Math.PI / 180;
  // return (Math.PI * (x1 * x2 + y1 * y2)) / (Math.sqrt(x1 ** 2 + y1 ** 2) * Math.sqrt(x2 ** 2 + y2 ** 2) * 180);
  const AB = x1 * x2 + y1 * y2;
  const aLength = Math.sqrt(x1 ** 2 + y1 ** 2);
  const bLength = Math.sqrt(x2 ** 2 + y2 ** 2);
  const cosAngle = AB / (aLength * bLength);
